...
/**
 * Theme settings panel for the visual builder
 * Shows inline theme selection when the "Tema" tab is active
 */
export function BuilderThemePanel({ onThemeChange }: BuilderThemePanelProps) {
  const { user } = useAuth()
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      ...
      <aside className="w-80 bg-card border-r flex flex-col overflow-hidden shrink-0">
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          {/* Theme selection */}
          <div className="space-y-3">
            <SectionTitle>{copy.themes.title}</SectionTitle>
            <ThemeCard
